...
class MollomAPI(object):
  ...
  def __init__(self, publicKey, privateKey, timeoutDays = 7, timeoutHours = 0, defaultServer = 'http://rest.mollom.com', defaultVersion = '1.0'):
  ...
  def __service(self, method, path, data, depth=0):
  ...
  def checkContent( self
    ...
    answer = self.__service('POST', 'content', data)
